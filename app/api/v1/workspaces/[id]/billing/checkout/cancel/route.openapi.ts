...
registry.registerPath({
  ...
  responses: {
    ...
    503: { description: 'The payment processor is unavailable in this environment (`payment_processor_unavailable`). Generic client message; the missing configuration is logged server-side only.', content: { 'application/json': { schema: ErrorEnvelopeSchema } } },
  },
});
