...
> Jira field: `customfield_10165` · [View in Jira](https://jira.upexgalaxy.com/browse/BK-27)
...
Index `test*steps(atc*id)` (RESTRICT enforcement + future [https://jira.upexgalaxy.com/browse/BK-22#icft=BK-22](https://jira.upexgalaxy.com/browse/BK-22#icft=BK-22) usage report). `atc_id` is a ***reference, not a copy*** — never snapshot ATC content into a Test (snapshots belong to Runs).
...
- [https://jira.upexgalaxy.com/browse/BK-32#icft=BK-32](https://jira.upexgalaxy.com/browse/BK-32#icft=BK-32): rich read-only Test detail pane/tab (full per-ATC expansion). BK-27's explorer Tests group is a list only; clicking does not open a `t:` tab yet.
- [https://jira.upexgalaxy.com/browse/BK-33#icft=BK-33](https://jira.upexgalaxy.com/browse/BK-33#icft=BK-33): `.tag` chip input on Tests.
- [https://jira.upexgalaxy.com/browse/BK-22#icft=BK-22](https://jira.upexgalaxy.com/browse/BK-22#icft=BK-22): "Used by N tests" wiring in ATC detail.
...
***Task:*** Make created Tests visible (TC-01 "appears in list"): fetch workspace Tests RLS-scoped in the project page and render a collapsible "Tests" group in the explorer panel — branch icon 12px `fg-3`, title, neutral `unrun` dot, NO layer chip; read-only list (opening as a `t:` tab = [https://jira.upexgalaxy.com/browse/BK-32#icft=BK-32](https://jira.upexgalaxy.com/browse/BK-32#icft=BK-32)). Must coexist with §5 D8 explorer behaviors (accordions, collapse/resize) without regressing them.
