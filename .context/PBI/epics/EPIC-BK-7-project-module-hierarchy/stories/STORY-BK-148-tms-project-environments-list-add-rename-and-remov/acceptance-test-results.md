...
> Jira field: `customfield_10124` · [View in Jira](https://jira.upexgalaxy.com/browse/BK-148)

## Acceptance Test Results — [https://jira.upexgalaxy.com/browse/BK-148#icft=BK-148](https://jira.upexgalaxy.com/browse/BK-148#icft=BK-148): TMS-Project Environments CRUD
...
- ***Improvement (Mejora):*** cross-workspace `PATCH`/`DELETE` on an existing environment returns 403, disclosing existence, where a non-disclosing 404 would be expected for a multi-tenant surface. No AC mandated non-disclosure → Improvement, not Bug. Linked to [https://jira.upexgalaxy.com/browse/BK-148#icft=BK-148](https://jira.upexgalaxy.com/browse/BK-148#icft=BK-148).
