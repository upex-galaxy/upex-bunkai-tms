...
- A result appears only if the viewer holds permission to see the underlying entity (active membership in the workspace that owns it); the palette never reveals the existence of an entity the viewer cannot otherwise access
