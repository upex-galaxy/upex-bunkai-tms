...
| --- | ----- | ------ | -------- | ------ |
| [BK-8](https://upexgalaxy67.atlassian.net/browse/BK-8) | Create a Project inside a Workspace | 1 | Medium | Estimation |
| [BK-9](https://upexgalaxy67.atlassian.net/browse/BK-9) | Create Modules (with nested sub-modules) inside a Project | 1 | Medium | Estimation |
| [BK-10](https://upexgalaxy67.atlassian.net/browse/BK-10) | Rename and soft-delete a Module (with cascade) | 1 | Medium | Estimation |
| [BK-11](https://upexgalaxy67.atlassian.net/browse/BK-11) | Move a Module to a different parent (with cycle-detection + path rebuild) | 1 | Medium | Estimation |
...
_Last sync: 2026-05-20T00:58:01.688Z_
