...
- Progress derives exclusively from existing run outcomes and refreshes when the plan is viewed.
- Click-through from a test row to that test's latest run.
- Plans list shows a compact progress indicator per plan.
