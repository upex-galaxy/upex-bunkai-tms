...
- Closed state: verdict chip, summary, closed-by, closed-at, and the progress snapshot at close time.
- Read-only enforcement on closed plans across details, membership, and close action.
- Plans list filterable by status Open or Closed.
