...
- Milestone detail view with its details and an empty plans area.
- Edit a milestone's name, description, and target date while it is active.
- Validation: name required and unique per project; target date today or later at creation.
