...
- Plan detail view with an empty state guiding the user to add tests.
- Edit a plan's name, description, and goal while the plan is open.
- Name validation with a clear duplicate-name message.
