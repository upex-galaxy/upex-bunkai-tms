...
- Plan membership is a reference to the Test, never a copy — a Test may belong to many plans.
- Duplicate prevention: tests already in the plan are marked as included in the picker.
- Live test count on the plan header and in the plans list.
