...
- Link previews for arbitrary external URLs — out
- Attaching files or screenshots — future iteration
- Acting on the entity from the card (starting a Run, editing the ATC) — out; the card navigates, it does not operate
