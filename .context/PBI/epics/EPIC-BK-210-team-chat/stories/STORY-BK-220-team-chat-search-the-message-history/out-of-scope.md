...
- Regular expressions or advanced query operators — future iteration
- Exporting search results — out
- Searching messages deleted before the search (tombstones are not searchable content) — out
