# BK-105 — Acceptance Test Plan (QA)

> Jira field: `customfield_10067` · [View in Jira](https://jira.upexgalaxy.com/browse/BK-105)

# Shift-Left Refinement — [https://jira.upexgalaxy.com/browse/BK-89#icft=BK-89](https://jira.upexgalaxy.com/browse/BK-89#icft=BK-89): TMS-Workspace | View the workspaces I belong to
...
### FINDING 3 — LOW: Navigation path depends on unshipped [https://jira.upexgalaxy.com/browse/BK-87#icft=BK-87](https://jira.upexgalaxy.com/browse/BK-87#icft=BK-87)

[https://jira.upexgalaxy.com/browse/BK-87#icft=BK-87](https://jira.upexgalaxy.com/browse/BK-87#icft=BK-87) (Settings Hub) is in "Ready For Dev" — the Settings section UI does not exist yet. [https://jira.upexgalaxy.com/browse/BK-89#icft=BK-89](https://jira.upexgalaxy.com/browse/BK-89#icft=BK-89) lives inside the Settings hub by naming convention. The page container, route, and navigation path are unknown until [https://jira.upexgalaxy.com/browse/BK-87#icft=BK-87](https://jira.upexgalaxy.com/browse/BK-87#icft=BK-87) ships.

***Impact on testability:*** Smoke and UI exploration tests cannot be written with a confirmed selector path. Functional logic tests (API-level) are unblocked, but UI integration tests carry a navigation-path risk that will require rework after [https://jira.upexgalaxy.com/browse/BK-87#icft=BK-87](https://jira.upexgalaxy.com/browse/BK-87#icft=BK-87) ships.
...
***Problem:*** The story says "When he opens the Workspaces section" but does not specify the route, tab, or navigation path. Given [https://jira.upexgalaxy.com/browse/BK-87#icft=BK-87](https://jira.upexgalaxy.com/browse/BK-87#icft=BK-87) (Settings Hub) is the expected container and it is not yet implemented, the entry point is undefined.

***Why it matters for testability:*** Without a confirmed route or navigation trigger, UI tests cannot navigate to the feature. This is a documentation gap rather than a design gap — it should be resolvable by linking [https://jira.upexgalaxy.com/browse/BK-87#icft=BK-87](https://jira.upexgalaxy.com/browse/BK-87#icft=BK-87) once its route is decided.
...
| I-03 | Navigation from Settings Hub ([https://jira.upexgalaxy.com/browse/BK-87#icft=BK-87](https://jira.upexgalaxy.com/browse/BK-87#icft=BK-87)) to Workspaces section lands on correct view | [https://jira.upexgalaxy.com/browse/BK-87#icft=BK-87](https://jira.upexgalaxy.com/browse/BK-87#icft=BK-87) Settings Hub must be shipped; route confirmed |
...
1. ***[****DEPENDENCY — UI path]*** What is the confirmed route and navigation path to the Workspaces section? This is blocked on [https://jira.upexgalaxy.com/browse/BK-87#icft=BK-87](https://jira.upexgalaxy.com/browse/BK-87#icft=BK-87) (Settings Hub). Please confirm the route (e.g., `/settings/workspaces`) and the parent nav element once [https://jira.upexgalaxy.com/browse/BK-87#icft=BK-87](https://jira.upexgalaxy.com/browse/BK-87#icft=BK-87) design is finalized, so UI outlines can be completed without rework.
