...
# [https://jira.upexgalaxy.com/browse/BK-3#icft=BK-3](https://jira.upexgalaxy.com/browse/BK-3#icft=BK-3) — Spec Implementation Plan (Dev)

OAuth (GitHub + Google) sign-up / sign-in, end-to-end. Greenfield across 3 layers (UI enable, server initiation, callback exchange) reusing the existing session, redirect, and onboarding infrastructure shipped by [https://jira.upexgalaxy.com/browse/BK-166#icft=BK-166](https://jira.upexgalaxy.com/browse/BK-166#icft=BK-166)/[https://jira.upexgalaxy.com/browse/BK-86#icft=BK-86](https://jira.upexgalaxy.com/browse/BK-86#icft=BK-86).
...
| D5 | ***Flip design master-plan §5 D1**** ("OAuth disabled until infra sequenced") → "delivered in BK-3; buttons enabled". | [https://jira.upexgalaxy.com/browse/BK-3#icft=BK-3](https://jira.upexgalaxy.com/browse/BK-3#icft=BK-3) **is* the infra sequencing D1 deferred. Doc update travels with the PR. |
