...
- Linking Bugs to commits or PRs — future traceability work in the Bugs epic line
- Entering CI metadata on manual runs — manual runs are not change-triggered
- Triggering pipelines from Bunkai — excluded epic-wide (no scheduling, no orchestration)
