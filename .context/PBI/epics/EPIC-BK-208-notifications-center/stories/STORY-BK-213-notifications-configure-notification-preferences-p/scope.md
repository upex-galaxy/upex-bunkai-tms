...
- Defaults: in-app and email on for run lifecycle and bug lifecycle.
- Mentions row visible but locked ("coming soon") until Team Chat ships.
- Changes apply immediately to future notifications and persist across sessions.
