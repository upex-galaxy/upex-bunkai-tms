...
- Notification content: bug title, what changed (assignment or the new status), and a deep link to the bug.
- Deep link lands on the bug with its attached test and run context.
