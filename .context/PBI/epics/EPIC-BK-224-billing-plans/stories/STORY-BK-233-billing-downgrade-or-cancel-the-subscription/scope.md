...
- Cancellation state visible in the Billing section (end date, resubscribe action)
- Resubscribe path that reverts a pending cancellation without double-charging
- Read-only treatment of over-limit resources after a downgrade takes effect
