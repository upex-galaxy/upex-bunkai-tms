...
- Enterprise contract termination (sales-assisted)
- Pausing a subscription or plan-change scheduling beyond the current period
- Data export tooling (worth considering with cancellation, but a separate concern)
