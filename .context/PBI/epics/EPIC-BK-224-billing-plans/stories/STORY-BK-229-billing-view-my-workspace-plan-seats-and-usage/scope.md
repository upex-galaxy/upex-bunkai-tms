...
- Seat meter: active members against the plan's seat limit
- Usage meters for plan-limited resources (projects, run history retention)
- Free-plan state with an upgrade entry point
- Warning visual state on meters approaching their limit
