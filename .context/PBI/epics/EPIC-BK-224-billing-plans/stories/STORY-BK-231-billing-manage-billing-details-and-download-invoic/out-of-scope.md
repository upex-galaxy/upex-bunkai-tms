...
- Editing invoices already issued — issued invoices are immutable
- Plan changes (upgrade / downgrade / cancel are separate stories)
- Multiple payment methods on file at once — one active method per workspace
