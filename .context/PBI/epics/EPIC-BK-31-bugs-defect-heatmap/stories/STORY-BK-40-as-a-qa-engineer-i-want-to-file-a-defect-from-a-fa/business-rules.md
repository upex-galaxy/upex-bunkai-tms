...
- When a defect is filed from inside a run, the failing ATC is automatically linked without manual entry
...
- A standalone defect filed outside a run is valid and carries no linked run or ATC
