...
```bash
git worktree add /Users/ely/Desktop/projects/bunkai/upex-bunkai-tms-wt-a -b feat/avalanche-worker-a staging
cp /Users/ely/Desktop/projects/bunkai/upex-bunkai-tms/.env /Users/ely/Desktop/projects/bunkai/upex-bunkai-tms-wt-a/.env
cd /Users/ely/Desktop/projects/bunkai/upex-bunkai-tms-wt-a
bun install
# Dev server is OPTIONAL for this run — live-UI validation is suspended (§9b), so you don't need one
# running by default. Start `bun run dev -- -p 3001` yourself only if you personally want to
