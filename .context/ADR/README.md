...
| [ADR-0005](./ADR-0005-pat-issuance-role-gate.md) | Role-gated PAT issuance; no global `workspace:admin` tokens | Proposed | — | — |
| [ADR-0006](./ADR-0006-consumption-side-scope-enforcement.md) | Consumption-side scope enforcement: TS capability gate + workspace context match | Proposed | — | — |
