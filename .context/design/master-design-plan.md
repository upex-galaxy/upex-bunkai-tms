...
### 4.2 Home / Dashboard — 🔶 (banner shipped; widgets 0%)
...
**Remaining widgets blocked by:** nothing at the data layer any more — runs (BK-30), bugs (BK-31) and coverage (BK-44) all shipped; the five widget stories are BK-256..BK-260 under epic BK-254. **Priority: P2.**
