...
| Sequential | `.agents/skills/test-automation/SKILL.md` (Stage 5) — Plan → Code → Review                         | 3 agents one at a time: Plan writes spec.md+implementation-plan.md, Code consumes them, Review verifies.        |
