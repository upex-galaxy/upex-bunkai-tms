...
- Update the AI memory file (`AGENTS.md`, never the `CLAUDE.md` shim) §Context System with a pointer to `.context/business/business-api-map.md` if not already present.
