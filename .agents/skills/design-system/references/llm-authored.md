...
1. **Spec asset present**: confirm `.agents/skills/design-system/assets/design-md-spec-summary.md` exists and is readable. This is the schema source of truth. Without it, the LLM can drift from the spec.
