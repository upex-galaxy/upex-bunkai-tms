...
export function WorkspacesList({ workspaces, error = false }: WorkspacesListProps) {
        ...
        <CardContent className="max-h-[400px] overflow-y-auto p-0" data-testid="workspaces-rows">
          {workspaces.map(ws => (
            <div
              ...
              className="grid grid-cols-[minmax(0,1fr)_auto_auto_auto] items-center gap-4 border-b border-stroke-1 px-4 py-3 last:border-b-0"
            >
